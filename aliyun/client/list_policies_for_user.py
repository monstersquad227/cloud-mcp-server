...
class AliyunClient(AliyunBaseClient):
    def list_policies_for_user(self, user_name: str):
        ...
        request = ram_models.ListPoliciesForUserRequest(user_name=user_name)
        resp = client.list_policies_for_user(request)
