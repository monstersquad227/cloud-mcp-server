from k8s.v1_18.client.get_deployment import KubernetesClient


def register(mcp):
    @mcp.tool("get_kubernetes_deployment")
    def get_deployment(
        namespace: str,
        name: str,
        ...
        return client.get_deployment(namespace=namespace, name=name)
